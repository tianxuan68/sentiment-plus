...
def polarity_text(polarity):
    return '正向' if polarity == 1 else '负向'


if __name__ == '__main__':
    print(f'属性类型：{ASPECT_TYPES}')
    print(f'BIO 标签：{bio_labels_for_aspects()}')
