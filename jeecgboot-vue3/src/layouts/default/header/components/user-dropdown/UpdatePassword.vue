...
<script lang="ts" setup>
  ...
  async function handleSubmit() {
    try {
      ...
      //提交表单
      let params = Object.assign({ username: unref(username) }, {
        oldpassword: encryptPasswordForTransmit(values.oldpassword),
        password: encryptPasswordForTransmit(values.password),
        confirmpassword: encryptPasswordForTransmit(values.confirmpassword),
      });
