        ...
        <div class="aui-container">
          <div class="aui-form">
            <div class="aui-formBox">
              ...
              <a-form @keyup.enter.native="loginHandleClick" v-if="enabledThirdSources.length > 0">
...
<script lang="ts" setup name="login-mini">
  import { getCaptcha, getCodeInfo, getThirdLoginConfig } from '/@/api/sys/user';
    ...
    deptTimer = setTimeout(async () => {
      ...
      if (departList.value && departList.value.length == 0) {
        ...
        if (loginType == 'account') {
          params['password'] = encryptPasswordForTransmit(formData.password);
 ...
 //**********************查询部门逻辑end*************************************************
  ...
  async function accountLogin() {
    ...
    try {
      ...
      // 密码使用AES加密传输
      const encryptedPassword = encryptPasswordForTransmit(formData.password);
