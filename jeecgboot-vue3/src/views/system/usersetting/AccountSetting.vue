...
<script lang="ts" setup>
  ...
  import UserReplacePhoneModal from './components/UserPhoneModal.vue';
  import UserReplaceEmailModal from './components/UserEmailModal.vue';
  import UserPasswordModal from './components/UserPasswordModal.vue';
  import UserPasswordNotBindPhone from './components/UserPasswordNotBindPhone.vue';
  import UserCancellationModal from './components/UserCancellationModal.vue';
